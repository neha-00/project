...
export default function VitalsCard() {
  return (
    <div className="grid grid-cols-2 gap-6 w-full">
      {/* Heart Rate */}
      <div className="bg-white rounded-2xl shadow-lg p-6 min-h-[150px] flex flex-col justify-between">
      ...
      {/* Body Temperature */}
      <div className="bg-white rounded-2xl shadow-lg p-6 min-h-[200px] flex flex-col justify-between relative">
        {/* Label */}
        <div className="flex items-center gap-2 text-sm font-semibold text-gray-600 mb-2">
          <span className="w-4 h-4 rounded-full inline-block mr-2 bj-sage"></span>
          Body Temperature
        ...
        {/* Thermometer Positioned Right and Taller */}
        <div className="flex justify-center">
          <img
            src={ThermometerIcon}
            alt="Thermometer Icon"
            className="h-[150px] ml-25" // Increase height and shift right
          />
        </div>

        {/* Temperature in bottom-left */}
